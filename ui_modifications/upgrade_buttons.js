function add_upgrade_buttons() {
    ...
    `html+=\`<div style='display: inline-block; vertical-align: top; padding-left: 5px'>
        <div style='display: block'>
            ...
            <div class='gamebutton clickable' onclick='buy("scroll0", 1000)' style='line-height: 18px; font-size: 24px; padding: 4px; border: 2px solid gray; margin-top: 2px'>+1000</div>
        </div>
        <div style='display: block'>
            ...
            <div class='gamebutton clickable' onclick='buy(\"scroll1\", 1000)' style='line-height: 18px; font-size: 24px; padding: 4px; border: 2px solid gray; margin-top: 2px'>+1000</div>
        </div>
        <div style='display: block'>
            ...
            <div class='gamebutton clickable' onclick='buy("scroll2", 1000)' style='line-height: 18px; font-size: 24px; padding: 4px; border: 2px solid gray; margin-top: 2px'>+1000</div>
        </div>
        <div style='display: block'>
            ${parent.item_container({skin: "scroll3", size:20, onclick:"buy('scroll3')"})}
            <div class='gamebutton clickable' onclick='buy("scroll3", 10)' style='line-height: 18px; font-size: 24px; padding: 4px; border: 2px solid gray; margin-top: 2px'>+10</div>
            <div class='gamebutton clickable' onclick='buy("scroll3", 1000)' style='line-height: 18px; font-size: 24px; padding: 4px; border: 2px solid gray; margin-top: 2px'>+1000</div>
        </div>
        <div style='display: block'>
            ${parent.item_container({skin: "skill_massproductionpp", size:30, onclick:"use_skill('massproduction'); upgrade(u_item,u_scroll,u_offering);"})}
